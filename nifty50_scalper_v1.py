...
Strategy: Opening Range Breakout + EMA Trend Confirmation

Instruments: NIFTY 50 Index (^NSEI)
...
- 2-minute cooldown after win
- Daily loss limit: -500 points
- Max 3 consecutive losses → stop trading

SIGNAL GENERATION:
1. Identify opening range (first 3 candles of session = 9:15-10:00 IST)
...
- Target: 3.0 × ATR(14) from entry
- Time exit: 100 candles maximum (≈25 hours of 15m bars)

PAPER INTEGRATION:
- Every signal logged to paper_trading_ledger
- Telegram alerts with [PAPER][NIFTY50-SCALPER-V1-DELAYED-DATA] prefix
...
CONFIG = {
    ...
    "bot_name": "NIFTY50-SCALPER-V1-DELAYED-DATA",
    "symbol": "NIFTY 50",
    "index_ticker": "^NSEI",
    "timeframe_minutes": 15,

    # Strategy parameters
    "opening_range_bars": 3,  # First 3 * 15min = 45 minutes of session
    "ema_period": 9,
    "atr_period": 14,
    ...
    "cooldown_minutes_after_win": 2,
    "daily_loss_limit_points": -500,
    "max_consecutive_losses": 3,
    "max_holding_candles": 100,  # ~25 hours of 15m candles
    ...
    "estimated_slippage_points": 5,  # Assume 5-point slippage
}
...
class Nifty50ScalperV1:
    """NIFTY50 scalper using opening range breakout strategy."""
    ...
    def can_entry(self, now: datetime) -> bool:
    ...
    def send_signal_alert(
        ...
        message = (
            f"{emoji} <b>[PAPER] NIFTY50-SCALPER-V1 — {direction}</b>\n"
            f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
...
if __name__ == "__main__":
    print("\n" + "=" * 80)
    print("NIFTY50-SCALPER-V1 (Paper Trading Research)")
    print("=" * 80)
    print(f"Bot ID: {CONFIG['bot_id']}")
    print(f"Mode: PAPER (no real broker orders)")
    print(f"Data: Delayed Yahoo Finance (~15-30min latency)")
    print(f"Strategy: Opening Range Breakout + EMA Confirmation")
    print("=" * 80 + "\n")

    print("Use: from nifty50_scalper_v1 import Nifty50ScalperV1")
    print("Example:")
    print("  scalper = Nifty50ScalperV1()")
