"""
Windows MT5 Trade Executor
Reads signals from trade queue and executes via MetaTrader5 Python API.
Implements fail-closed execution guards from canonical telegram_config.py
"""
...
QUEUE_FILE = os.getenv("TRADE_QUEUE_PATH", ".trade_queue.jsonl")
